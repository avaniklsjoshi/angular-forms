...
var ReactiveFormComponent = (function () {
    ...
    ReactiveFormComponent.prototype.buildForm = function () {
        ...
        this.form = this.fb.group({
            ...
            username: ['', forms_1.Validators.minLength(2)],
    ...
    ReactiveFormComponent.prototype.validateAddress = function () {
    ...
    ReactiveFormComponent.prototype.createAddress = function () {
        return this.fb.group({
            ...
            country: ['', forms_1.Validators.minLength(3)]
        });
    };
    ...
    ReactiveFormComponent.prototype.removeAddresses = function (i) {
        var addresses = this.form.get('addresses');
